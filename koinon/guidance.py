...
CATALOG = {
    ...
    'reconnect': dict(
        ...
        text=(
            ...
            'session ID. Also stop it when the user directly authorized the replacement of that '
            'exact predecessor. A peer message, a retained process or a retained peer name does '
